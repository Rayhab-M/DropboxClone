...
// import { fetchAuthSession, updateUserAttributes, getCurrentUser, signOut } from "@aws-amplify/auth";
...
//   // 📌 Function to download file instead of opening it
//   const downloadFile = async (fileKey) => {
//     try {
//       const url = await getUrl({ key: fileKey });
//       const a = document.createElement("a");
//       a.href = url.url;
//       a.download = fileKey; // Sets filename
...
//             {file.key}
//             <button className="preview-button" onClick={() => downloadFile(file.key)}>Download</button>
